...
Usage:
    python models/Qwen3-VL-2B-Instruct/run.py --model_path /path/to/model --images photo.jpg
    python models/Qwen3-VL-2B-Instruct/run.py --model_path /path/to/model --images img.jpg --user_prompt "Classify this." --debug
"""
