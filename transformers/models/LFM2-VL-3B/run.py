...
Usage:
    python models/LFM2-VL-3B/run.py --model_path /path/to/model --images photo.jpg
    python models/LFM2-VL-3B/run.py --model_path /path/to/model --images img.jpg --user_prompt "Classify this." --debug
"""
